...
DATABASES = {
    'default': {
        ...
        'NAME': 'guppylist',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'y-oq*$ij0^k&frkn47n$l+bbo32chy1eu#23#=+37p9l(81y(v'
...
MIDDLEWARE_CLASSES = (
    ...
    'guppylist.core.middleware.RequestMiddleware',
...
WSGI_APPLICATION = 'guppylist.wsgi.application'
